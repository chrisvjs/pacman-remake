...
public class PacManGUIMedium extends JFrame {

	// Adds Frames and Panels and Labels
	private BoardMedium board = new BoardMedium();
	
	MenuBar menubar = new MenuBar();

	public static JPanel scoreboardPanel = new JPanel(null);

	public static JLabel score = new JLabel("Score: " + Board.score);

	public static JLabel highScore = new JLabel("High Score for current session: " + Board.highScore);

	public static JLabel lives = new JLabel("Lives: " + Board.lives);

	// Makes the frame, sets size, name
	public PacManGUIMedium() {
